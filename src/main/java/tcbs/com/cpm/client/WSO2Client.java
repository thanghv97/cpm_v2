...
public interface WSO2Client {
    ...
    ResponseEntity<Object> addMemberToGroup(@PathVariable String id, @RequestBody PatchOpAddReq body);

    @PostMapping(value = "/Groups/{id}", consumes = "application/json")
    ResponseEntity<Object> removeMemberFromGroup(@PathVariable String id, @RequestBody PatchOppRemoveReq body);
}
